...
const Orders = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 w-[1100px] py-10 max-md:py-2 h-fit border-[1px] border-gray-200 rounded-md flex flex-col gap-7 items-center px-[40px] max-md:w-full max-sm:px-[10px]">
