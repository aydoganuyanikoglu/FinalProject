...
const LoginScreen = () => {
  return (
    <div
      className={`relative w-full h-fit min-h-[100vh] py-[100px] flex flex-col gap-10 items-center justify-center max-sm:justify-center max-sm:py-[150px] ${styles.pagePaddingX}`}
    >
